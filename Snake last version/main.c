...
void Print()
{
   ...
   printf("\n-> Use arrow keys to move the snake.\n\n-> You will be provided food and bonus points at the several coordinates of the screen which you have to eat. Everytime you eat food the length of the snake will be increased by 1 element and thus the score or 2 if you a bonus point.\n\n-> Here you are provided with three lives. Your life will decrease as you hit the wall or snake's body.\n\n-> You can pause the game in its middle by pressing any key. To continue press any other key\n\n-> If you want to exit press esc. \n");
